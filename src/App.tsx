...
function AppContent() {
  ...
  return (
    <div className="flex flex-col h-screen bg-[var(--app-bg)] text-[var(--text-primary)]">
      <Header />
      <InputPanel />
      <PlanTabs />
      ...
      {anyPlanParsed && (
        <div className="flex flex-1 min-h-0 overflow-hidden">
          ...
          <div className="flex-1 flex flex-col relative min-w-0 bg-[var(--surface)] border-r border-l border-[var(--border-color)]">
            <VisualizationTabs />
            <Legend />
          </div>
          {!isCompareView && (
