    ...
    <div className="flex flex-col h-screen bg-[var(--app-bg)] dark:bg-[var(--app-bg-dark)] text-[var(--text-primary)] dark:text-[var(--text-primary-dark)]">
      ...
      {anyPlanParsed && (
        <div className="flex flex-1 min-h-0 overflow-hidden">
          ...
          <div className="flex-1 flex flex-col relative min-w-0 bg-[var(--surface-raised)] dark:bg-[var(--surface-dark)] border-r border-l border-[var(--border-color)] dark:border-[var(--border-color-dark)]">
            <VisualizationTabs />
            <Legend />
          </div>
          {!isCompareView && (
      ...
      {!anyPlanParsed && (
        <div className="flex-1 flex flex-col items-center justify-center text-[var(--text-muted)] dark:text-[var(--text-muted-dark)] p-8">
          <svg
            className="w-16 h-16 mb-4 text-[var(--border-color)] dark:text-[var(--border-color-dark)]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
          ...
          <h2 className="text-xl font-semibold text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] mb-2">
