  ...
  return (
    ...
    >
      <button
        ...
        className="absolute right-0 top-0 z-10 h-full w-2 cursor-col-resize touch-none bg-transparent hover:bg-[var(--border-color)]/70 dark:hover:bg-[var(--border-color-dark)]/70 transition-colors"
        ...
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-1 hover:bg-[var(--surface-raised)] dark:hover:bg-[var(--surface-raised-dark)] rounded-lg transition-colors"
      ...
      {/* Search */}
      <div className="p-3 border-b border-[var(--border-color)] dark:border-[var(--border-color-dark)]">
        <label className="block text-[10px] uppercase tracking-widest font-semibold text-[var(--text-muted)] dark:text-[var(--text-muted-dark)] mb-2">
          Search
        </label>
        <input
          type="text"
          ...
          className="w-full px-2.5 py-1.5 text-xs border border-[var(--border-color)] dark:border-[var(--border-color-dark)] rounded-lg bg-[var(--surface)] dark:bg-[var(--surface-card-dark)] text-[var(--text-primary)] dark:text-[var(--text-primary-dark)] placeholder-[var(--text-muted)] dark:placeholder-[var(--text-muted-dark)] focus:outline-none focus:ring-2 focus:ring-cyan-500/60"
        />
            ...
            {searchMatches.length > 0 && (
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="px-2 py-1 rounded-lg border border-[var(--border-color)] dark:border-[var(--border-color-dark)] bg-[var(--surface)] dark:bg-[var(--surface-card-dark)] text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] hover:bg-[var(--surface-raised)] dark:hover:bg-slate-700 transition-colors"
      ...
      {/* Predicate Types */}
      <div className="p-3 border-b border-[var(--border-color)] dark:border-[var(--border-color-dark)]">
        <label className="block text-[10px] uppercase tracking-widest font-semibold text-[var(--text-muted)] dark:text-[var(--text-muted-dark)] mb-3">
          Predicate Types
        </label>
          ...
          {([
            ...
            return (
              <button
                ...
                className={`
                  w-full flex items-center justify-between px-2.5 py-1.5 text-xs rounded-lg transition-colors
                  ${
                    isActive
                      ? 'bg-cyan-50 dark:bg-cyan-900/20 text-cyan-700 dark:text-cyan-300 border border-cyan-200 dark:border-cyan-800'
                      : 'bg-[var(--surface-raised)] dark:bg-[var(--surface-card-dark)] text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] border border-[var(--border-color)] dark:border-[var(--border-color-dark)] hover:bg-slate-100 dark:hover:bg-slate-700'
                  }
                `}
              >
                <span className="truncate">{label}</span>
                <span className="ml-2 px-2 py-0.5 bg-[var(--surface)] dark:bg-[var(--surface-dark)] rounded-md text-[11px]">
                  {count}
                </span>
              </button>
            );
