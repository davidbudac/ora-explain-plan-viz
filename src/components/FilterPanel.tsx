...
export function FilterPanel({ panelWidth, onResizeStart }: FilterPanelProps) {
  ...
  return (
    ...
    >
      ...
      {/* Search */}
      <div className="p-3 border-b border-[var(--border-color)] dark:border-[var(--border-color-dark)]">
        <label className="block text-xs font-semibold text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] mb-2">
          Search
        </label>
        <input
          type="text"
          ...
          className="w-full px-2.5 py-1.5 text-xs border border-[var(--border-color)] dark:border-[var(--border-color-dark)] rounded-lg bg-[var(--surface)] dark:bg-[var(--surface-raised-dark)] text-[var(--text-primary)] dark:text-[var(--text-primary-dark)] placeholder-[var(--text-muted)] dark:placeholder-[var(--text-muted-dark)] focus:outline-none focus:ring-2 focus:ring-indigo-500/60"
        />
            ...
            {searchMatches.length > 0 && (
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="px-2 py-1 rounded border border-[var(--border-color)] dark:border-[var(--border-color-dark)] bg-[var(--surface)] dark:bg-[var(--surface-dark)] text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] hover:bg-[var(--surface-raised)] dark:hover:bg-[var(--surface-raised-dark)] transition-colors"
      ...
      {/* Predicate Types */}
      <div className="p-3 border-b border-[var(--border-color)] dark:border-[var(--border-color-dark)]">
        <label className="block text-xs font-semibold text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] mb-3">
          Predicate Types
        </label>
                ...
                className={`
                  ...
                  ${
                    isActive
                      ...
                      : 'bg-[var(--surface-raised)] dark:bg-[var(--surface-raised-dark)] text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] border border-[var(--border-color)] dark:border-[var(--border-color-dark)] hover:bg-[var(--surface-raised)] dark:hover:bg-[var(--surface-raised-dark)]'
                  }
                `}
              >
                <span className="truncate">{label}</span>
                <span className="ml-2 px-2 py-0.5 bg-[var(--surface)] dark:bg-[var(--surface-dark)] rounded text-[11px]">
                  {count}
                </span>
              </button>
            );
