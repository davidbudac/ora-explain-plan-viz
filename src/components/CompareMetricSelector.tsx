...
export function CompareMetricSelector() {
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="text-xs text-[var(--text-muted)] dark:text-[var(--text-muted-dark)] font-medium">Metrics:</span>
            ...
            <button
              ...
              className={`
                ...
                ${isActive
                  ...
                  : 'bg-slate-50 dark:bg-slate-800 text-[var(--text-muted)] dark:text-[var(--text-muted-dark)] border-[var(--border-color)] dark:border-[var(--border-color-dark)] hover:bg-slate-100 dark:hover:bg-slate-700'
                }
              `}
            >
