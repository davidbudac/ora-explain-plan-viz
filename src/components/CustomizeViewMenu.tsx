  ...
  return (
    <div className="relative">
      <button
        ...
        className="w-full h-8 px-2.5 rounded-lg border border-[var(--border-color)] dark:border-[var(--border-color-dark)] bg-[var(--surface)] dark:bg-[var(--surface-dark)] text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] text-xs font-semibold hover:bg-[var(--surface-raised)] dark:hover:bg-[var(--surface-raised-dark)] transition-colors flex items-center justify-between"
      >
        ...
        >
          <div className="p-2 border-b border-[var(--border-color)] dark:border-[var(--border-color-dark)]">
            <input
              ...
              className="w-full px-2 py-1.5 text-xs rounded-lg border border-[var(--border-color)] dark:border-[var(--border-color-dark)] bg-[var(--surface-raised)] dark:bg-[var(--surface-raised-dark)] text-[var(--text-primary)] dark:text-[var(--text-primary-dark)] placeholder-[var(--text-muted)] dark:placeholder-[var(--text-muted-dark)] focus:outline-none focus:ring-2 focus:ring-indigo-500/60"
            />
                        ...
                        <button
                          ...
                          className={`px-1.5 py-0.5 text-[10px] rounded transition-colors ${
                            allOn
                              ...
                              : 'text-[var(--text-muted)] dark:text-[var(--text-muted-dark)] hover:text-indigo-500 dark:hover:text-indigo-400'
                          }`}
                          disabled={allOn}
                        >
                          All on
