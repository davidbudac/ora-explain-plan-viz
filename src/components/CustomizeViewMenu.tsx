  ...
  return (
    <div className="relative">
      <button
        ...
        className="w-full h-8 px-2.5 rounded-lg border border-[var(--border-color)] dark:border-[var(--border-color-dark)] bg-[var(--surface)] dark:bg-[var(--surface-card-dark)] text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] text-xs font-semibold hover:bg-[var(--surface-raised)] dark:hover:bg-slate-700 transition-colors flex items-center justify-between"
      >
      ...
      {open && createPortal(
        <div
          ...
          className="fixed z-[80] w-[320px] max-w-[calc(100vw-1rem)] rounded-lg border border-[var(--border-color)] dark:border-[var(--border-color-dark)] bg-[var(--surface)] dark:bg-[var(--surface-dark)] shadow-xl"
        ...
        >
          <div className="p-2 border-b border-[var(--border-color)] dark:border-[var(--border-color-dark)]">
            <input
              ...
              className="w-full px-2 py-1.5 text-xs rounded-lg border border-[var(--border-color)] dark:border-[var(--border-color-dark)] bg-[var(--surface-raised)] dark:bg-[var(--surface-card-dark)] text-[var(--text-primary)] dark:text-[var(--text-primary-dark)] placeholder-[var(--text-muted)] dark:placeholder-[var(--text-muted-dark)] focus:outline-none focus:ring-2 focus:ring-cyan-500/60"
            />
            <div className="mt-2 flex gap-1">
              <button
                type="button"
                onClick={resetDefaults}
                className="px-2 py-1 text-[11px] rounded-lg border border-[var(--border-color)] dark:border-[var(--border-color-dark)] bg-[var(--surface)] dark:bg-[var(--surface-card-dark)] text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] hover:bg-[var(--surface-raised)] dark:hover:bg-slate-700"
              >
                Reset defaults
              </button>
              <button
                    ...
                    {sectionTotal > 1 && (
                      <div className="flex gap-1">
                        <button
                          ...
                          className={`px-1.5 py-0.5 text-[10px] rounded-lg transition-colors ${
                            allOn
                              ? 'text-[var(--text-muted)] dark:text-[var(--text-muted-dark)] cursor-default'
                              : 'text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] hover:text-cyan-600 dark:hover:text-cyan-400'
                          }`}
                          disabled={allOn}
                        >
                          All on
                    ...
                    {group.items.map((command) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full px-2 py-1.5 rounded-lg text-xs border transition-colors flex items-center justify-between ${
                            enabled
                              ? 'bg-cyan-50 dark:bg-cyan-900/30 border-cyan-200 dark:border-cyan-700 text-cyan-700 dark:text-cyan-300'
                              : 'bg-[var(--surface)] dark:bg-[var(--surface-card-dark)] border-[var(--border-color)] dark:border-[var(--border-color-dark)] text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] hover:bg-[var(--surface-raised)] dark:hover:bg-slate-700'
                          }`}
                        >
