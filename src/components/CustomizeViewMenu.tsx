  ...
  return (
    <div className="relative">
      <button
        ...
        className="w-full h-8 px-2.5 rounded-sm border border-[var(--border-color)] dark:border-[var(--border-color-dark)] bg-[var(--surface)] dark:bg-[var(--surface-raised-dark)] text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] text-xs font-semibold hover:bg-[var(--surface-raised)] dark:hover:bg-[var(--surface-dark)] transition-colors flex items-center justify-between"
      >
      ...
      {open && createPortal(
        <div
          ...
          className="fixed z-[80] w-[320px] max-w-[calc(100vw-1rem)] rounded-sm border border-[var(--border-color)] dark:border-[var(--border-color-dark)] bg-[var(--surface)] dark:bg-[var(--surface-dark)] shadow-xl"
        ...
        >
          <div className="p-2 border-b border-[var(--border-color)] dark:border-[var(--border-color-dark)]">
            <input
              ...
              className="w-full px-2 py-1.5 text-xs rounded-sm border border-[var(--border-color)] dark:border-[var(--border-color-dark)] bg-[var(--surface-raised)] dark:bg-[var(--app-bg-dark)] text-[var(--text-primary)] dark:text-[var(--text-primary-dark)] placeholder-[var(--text-muted)] dark:placeholder-[var(--text-muted-dark)] focus:outline-none focus:ring-2 focus:ring-blue-500/60"
            />
            <div className="mt-2 flex gap-1">
              <button
                type="button"
                onClick={resetDefaults}
                className="px-2 py-1 text-[11px] rounded border border-[var(--border-color)] dark:border-[var(--border-color-dark)] bg-[var(--surface)] dark:bg-[var(--surface-raised-dark)] text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] hover:bg-[var(--surface-raised)] dark:hover:bg-[var(--surface-dark)]"
              >
                Reset defaults
              </button>
              <button
                        ...
                        <button
                          ...
                          className={`px-1.5 py-0.5 text-[10px] rounded transition-colors ${
                            allOn
                              ...
                              : 'text-[var(--text-muted)] dark:text-[var(--text-muted-dark)] hover:text-blue-600 dark:hover:text-blue-400'
                          }`}
                          disabled={allOn}
                        >
                          All on
                    ...
                    {group.items.map((command) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full px-2 py-1.5 rounded-sm text-xs border transition-colors flex items-center justify-between ${
                            enabled
                              ? 'bg-blue-50 dark:bg-blue-900/30 border-blue-200 dark:border-blue-700 text-blue-700 dark:text-blue-300'
                              : 'bg-[var(--surface)] dark:bg-[var(--surface-raised-dark)] border-[var(--border-color)] dark:border-[var(--border-color-dark)] text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] hover:bg-[var(--surface-raised)] dark:hover:bg-[var(--surface-dark)]'
                          }`}
                        >
