    ...
    return (
      ...
      >
        <button
          ...
          className="absolute left-0 top-0 z-10 h-full w-2 cursor-col-resize touch-none bg-transparent hover:bg-[var(--border-color)]/30 dark:hover:bg-[var(--border-color-dark)]/30 transition-colors"
          aria-label="Resize details panel"
          title="Resize details panel"
        />
        <div className="p-3 border-b border-[var(--border-color)] dark:border-[var(--border-color-dark)] bg-[var(--surface-raised)] dark:bg-[var(--app-bg-dark)]/40">
              ...
              {worstNodes.byTime.map(n => (
                ...
                >
                  <span className="flex items-center gap-1.5 truncate">
                    <span className="w-5 h-5 rounded-sm bg-blue-600 dark:bg-blue-500 text-white dark:text-white text-[10px] font-bold flex items-center justify-center shrink-0">{n.id}</span>
            ...
            <div className="space-y-1">
              {annotations.groups.map((group) => {
                ...
                return (
                  ...
                  >
                    <span className="flex items-center gap-1.5 truncate">
                      <span className={`w-3 h-3 rounded-sm shrink-0 ${colorDef}`} />
                    ...
                    <button
                      ...
                      className="p-0.5 hover:bg-[var(--surface-raised)] dark:hover:bg-[var(--surface-dark)] rounded"
                      title="Edit group"
                    >
      ...
      >
        ...
        <div className="p-3 border-b border-[var(--border-color)] dark:border-[var(--border-color-dark)] bg-[var(--surface-raised)] dark:bg-[var(--app-bg-dark)]/40">
          <div className="flex items-start justify-between">
            <div>
              <span className="inline-block px-2 py-0.5 rounded text-[11px] font-semibold border border-slate-300 dark:border-slate-700 text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] bg-[var(--surface)] dark:bg-[var(--surface-dark)]">
                Multi Selection
              </span>
        ...
        <div className="p-3 border-b border-[var(--border-color)] dark:border-[var(--border-color-dark)]">
          ...
          <button
            ...
            className="mt-2 w-full px-2.5 py-1.5 text-xs font-medium text-blue-700 dark:text-blue-300 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-sm hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors"
          >
        ...
        <div className="p-3 border-b border-[var(--border-color)] dark:border-[var(--border-color-dark)]">
          ...
          <div className="h-2.5 bg-slate-200 dark:bg-slate-700 rounded-sm overflow-hidden">
            <div
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <div className="mt-2 flex items-center gap-2">
              <span className="w-6 h-6 rounded-sm bg-blue-600 dark:bg-blue-500 text-white dark:text-white text-xs font-bold flex items-center justify-center">
                {node.id}
              </span>
        ...
        <div className="p-3">
          ...
          {node.accessPredicates && (
            <div className="mb-3">
              ...
              <code className="block text-xs bg-slate-50 dark:bg-slate-950 p-2 rounded border border-[var(--border-color)] dark:border-[var(--border-color-dark)] text-slate-800 dark:text-slate-200 font-mono whitespace-pre-wrap break-all">
...
function StatItem({ label, value, highlight }: { label: string; value?: string; highlight?: 'blue' | 'purple' | 'orange' }) {
  ...
  return (
    <div className={`rounded-sm p-2 border border-[var(--border-color)] dark:border-[var(--border-color-dark)] ${highlight ? highlightStyles[highlight] : 'bg-slate-50 dark:bg-slate-950'}`}>
...
function CopyButton({ text, label }: { text: string; label?: string }) {
  ...
  return (
    <button
      onClick={handleCopy}
      className="p-1 hover:bg-[var(--surface-raised)] dark:hover:bg-[var(--surface-dark)] rounded transition-colors"
