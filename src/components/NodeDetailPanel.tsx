    ...
    return (
      <div className="bg-[var(--surface)] dark:bg-[var(--surface-dark)] border-l border-[var(--border-color)] dark:border-[var(--border-color-dark)] flex flex-col items-center py-3">
        <button
          ...
          className="h-8 w-8 flex items-center justify-center hover:bg-[var(--surface-raised)] dark:hover:bg-[var(--surface-raised-dark)] rounded-md transition-colors border border-[var(--border-color)] dark:border-[var(--border-color-dark)]"
          title="Show details"
        >
        ...
        <div className="p-3 border-b border-[var(--border-color)] dark:border-[var(--border-color-dark)] bg-[var(--surface-raised)] dark:bg-[var(--surface-raised-dark)]/40">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="p-1 hover:bg-[var(--surface-raised)] dark:hover:bg-[var(--surface-raised-dark)] rounded-full transition-colors"
            ...
            <div className="space-y-1">
              {worstNodes.byTime.map(n => (
                <button
                  ...
                  className="w-full text-left px-2 py-1.5 text-xs rounded-full hover:bg-[var(--surface-raised)] dark:hover:bg-[var(--surface-raised-dark)] transition-colors flex items-center justify-between gap-2"
                >
            ...
            <div className="space-y-1">
              {annotations.groups.map((group) => {
                ...
                return (
                  <div
                    key={group.id}
                    className="flex items-center justify-between px-2 py-1.5 text-xs rounded-full hover:bg-[var(--surface-raised)] dark:hover:bg-[var(--surface-raised-dark)] transition-colors"
                  >
                    <span className="flex items-center gap-1.5 truncate">
                    ...
                    <button
                      ...
                      className="p-0.5 hover:bg-[var(--surface-raised)] dark:hover:bg-[var(--surface-raised-dark)]rounded-full"
                      title="Edit group"
                    >
      ...
      >
        ...
        <div className="p-3 border-b border-[var(--border-color)] dark:border-[var(--border-color-dark)] bg-[var(--surface-raised)] dark:bg-[var(--surface-raised-dark)]/40">
          <div className="flex items-start justify-between">
            <div>
              <span className="inline-block px-2 py-0.5 rounded-full text-[11px] font-semibold border border-slate-300 dark:border-slate-700 text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] bg-[var(--surface)] dark:bg-[var(--surface-dark)]">
                Multi Selection
              </span>
            ...
            <div className="flex items-center gap-1">
              <button
                onClick={() => setIsCollapsed(true)}
                className="p-1 hover:bg-[var(--surface-raised)] dark:hover:bg-[var(--surface-raised-dark)]rounded-full"
                title="Collapse panel"
              >
                <svg className="w-4 h-4 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 5l7 7-7 7M5 5l7 7-7 7" />
        ...
        <div className="p-3 border-b border-[var(--border-color)] dark:border-[var(--border-color-dark)]">
          ...
          <button
            ...
            className="mt-2 w-full px-2.5 py-1.5 text-xs font-medium text-orange-700 dark:text-orange-300 bg-orange-50 dark:bg-orange-900/20 border border-blue-200 dark:border-blue-800 rounded-md hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors"
          >
  ...
  return (
    ...
    >
      ...
      <div className={`p-3 border-b border-[var(--border-color)] dark:border-[var(--border-color-dark)] ${colors.bg}`}>
        <div className="flex items-start justify-between">
          <div>
            <span className={`inline-block px-2 py-0.5 rounded-full text-[11px] font-semibold ${colors.text} ${colors.bg} border ${colors.border}`}>
              {category}
            </span>
        ...
        {(node.queryBlock || node.objectAlias) && (
          <div className="mt-2 flex flex-wrap gap-2">
            ...
            {node.objectAlias && (
              <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-200">
                {node.objectAlias}
              </span>
            )}
          </div>
        ...
        <div className="p-3">
          ...
          {node.accessPredicates && (
            <div className="mb-3">
              ...
              <code className="block text-xs bg-[var(--surface-raised)] dark:bg-[var(--surface-raised-dark)] p-2 rounded-full border border-[var(--border-color)] dark:border-[var(--border-color-dark)] text-slate-800 dark:text-slate-200 font-mono whitespace-pre-wrap break-all">
...
function StatItem({ label, value, highlight }: { label: string; value?: string; highlight?: 'blue' | 'purple' | 'orange' }) {
  ...
  const highlightStyles = {
    blue: 'bg-orange-50 dark:bg-orange-900/20 border border-blue-200 dark:border-blue-800',
  ...
  const valueStyles = {
    blue: 'text-orange-700 dark:text-orange-300',
    purple: 'text-purple-700 dark:text-purple-300',
    orange: 'text-orange-700 dark:text-orange-300',
  };

  return (
    <div className={`rounded-md p-2 border border-[var(--border-color)] dark:border-[var(--border-color-dark)] ${highlight ? highlightStyles[highlight] : 'bg-[var(--surface-raised)] dark:bg-[var(--surface-raised-dark)]'}`}>
