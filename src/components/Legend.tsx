...
export function Legend() {
  ...
  return (
    <div className="absolute bottom-3 left-3 z-10">
      {isVisible ? (
        <div className="bg-[var(--surface)]/95 dark:bg-[var(--surface-dark)]/95 backdrop-blur-sm rounded-xl shadow-lg p-2.5 border border-[var(--border-color)] dark:border-[var(--border-color-dark)]">
          <div className="flex items-center justify-between mb-2">
            ...
            <button
              ...
              className="p-0.5 hover:bg-[var(--surface-raised)] dark:hover:bg-[var(--surface-raised-dark)] rounded-full transition-colors"
              title="Hide legend"
            >
        ...
        <button
          ...
          className="bg-[var(--surface)]/95 dark:bg-[var(--surface-dark)]/95 backdrop-blur-sm rounded-xl shadow-lg p-1.5 border border-[var(--border-color)] dark:border-[var(--border-color-dark)] hover:shadow-xl transition-all"
          title="Show legend"
        >
