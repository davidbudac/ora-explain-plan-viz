  ...
  return (
    <button
      ...
      className={`
        ...
        ${current === metric ? activeClass : 'text-[var(--text-secondary)] dark:text-[var(--text-secondary-dark)] hover:bg-[var(--surface-raised)] dark:hover:bg-[var(--surface-raised-dark)]'}
      `}
    >
      {label}
    </button>
      ...
      <div className="flex items-center justify-between px-3 py-1.5 bg-[var(--surface)] dark:bg-[var(--surface-dark)] border-b border-[var(--border-color)] dark:border-[var(--border-color-dark)] gap-2">
        ...
        {viewMode === 'hierarchical' && (
          <div className="flex items-center gap-2">
            ...
            <div className="flex bg-[var(--surface-raised)] dark:bg-[var(--surface-raised-dark)] rounded-lg p-0.5 border border-[var(--border-color)] dark:border-[var(--border-color-dark)]">
              <IndicatorButton
                metric="cost"
                label="Cost"
                current={nodeIndicatorMetric}
